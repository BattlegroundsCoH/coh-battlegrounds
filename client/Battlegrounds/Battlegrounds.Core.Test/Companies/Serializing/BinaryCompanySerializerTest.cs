...
public class BinaryCompanySerializerTest {
    ...
    public void SetUp() {
        ...
        _serializer = new BinaryCompanySerializer(CoreTest.Services.GetService<ILogger<BinaryCompanySerializer>>()!, _companyService, _blueprintService);
    }
    ...
    public void WillDeserialise() {
        ...
        _companyService.GetCompanyTemplate(CompanyTemplateFixture.DESERT_RATS.Id).Returns(CompanyTemplateFixture.DESERT_RATS);
