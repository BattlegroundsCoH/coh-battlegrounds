...
namespace Battlegrounds.Lua.Generator.RuntimeServices {
    ...
    public abstract class LuaConverter {
        ...
        /// <summary>
        /// Write <paramref name="value"/> into its lua representation using <paramref name="luaSourceWriter"/>.
        /// </summary>
        /// <param name="luaSourceWriter">The source writer instance to write representation to.</param>
        /// <param name="value">The object to write</param>
        public abstract void Write(LuaSourceWriter luaSourceWriter, object value);
    ...
    public abstract class LuaConverter<T> : LuaConverter where T : class {
        ...
        public sealed override void Write(LuaSourceWriter luaSourceWriter, object value) => this.Write(luaSourceWriter, value as T);
        ...
        /// <param name="luaSourceWriter">The source writer instance to write representation to.</param>
        /// <param name="value">The specific <typeparamref name="T"/> instance to convert.</param>
        public abstract void Write(LuaSourceWriter luaSourceWriter, T value);
