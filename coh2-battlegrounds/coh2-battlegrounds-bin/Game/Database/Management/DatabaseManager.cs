...
public static class DatabaseManager {
    ...
    private static event DatabaseLoadedHandler? __databaseLoadedCallbacks;
    ...
    public static async void LoadAllDatabases(DatabaseLoadedCallbackHandler onDatabaseLoaded) {
        ...
        // Invoke other callback listeners
        __databaseLoadedCallbacks?.Invoke();
    ...
    public static void LoadedCallback(DatabaseLoadedHandler loadedHandler) {
        ...
        // subscribe
        __databaseLoadedCallbacks += loadedHandler;
