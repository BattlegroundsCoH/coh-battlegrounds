...
/// </summary>
public static class BattlegroundsContext {
    ...
    private static IModManager __modManager;
    private static IModDbManager __modDatabases;
    ...
    /// <summary>
    /// Get or set the mod manager used by the <see cref="BattlegroundsContext"/>
    /// </summary>
    public static IModManager ModManager {
        get => __modManager;
        set => __modManager = value;
    }

    /// <summary>
    /// Get or set the data source used by the <see cref="BattlegroundsContext"/>.
    /// </summary>
    public static IModDbManager DataSource {
        get => __modDatabases;
        set => __modDatabases = value;
    }
    ...
    /// Static constructor
    /// </summary>
    static BattlegroundsContext() {
        __modManager = new ModManager();
        __modDatabases = new ModDatabaseManager(__modManager);
        try {
            LoadInstance();
        } catch {
