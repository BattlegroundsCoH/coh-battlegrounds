...
/// <summary>
/// Class representing a pool of <typeparamref name="T"/> elements, where only available elements are shown visually. Extends <see cref="ObservableCollection{T}"/>.
/// </summary>
/// <typeparam name="T"></typeparam>
public sealed class Pool<T> : ObservableCollection<T> {
