...
public class LuaFunction {
    ...
    private readonly LuaCSharpFuncDelegate? m_csharpDelegate;
    private readonly LuaExpr? m_luaTop;
    ...
    /// </summary>
    [MemberNotNullWhen(true, nameof(this.m_csharpDelegate), nameof(Delegate))]
    ...
    public LuaFunction(LuaCSharpFuncDelegate funcDelegate) {
        ...
        this.m_params = Array.Empty<string>();
        this.m_luaTop = null;
    }
