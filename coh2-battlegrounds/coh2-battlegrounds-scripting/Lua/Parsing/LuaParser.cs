...
using Battlegrounds.Scripting.Lua.Parsing.Operators;

using RegexMatch = System.Text.RegularExpressions.Match;

namespace Battlegrounds.Scripting.Lua.Parsing;
// https://www.lua.org/manual/5.1/manual.html

/// <summary>
/// Parser class for parsing Lua source code.
/// </summary>
[Obsolete("Do **NOT** attempt to parse lua with this parser. It sucks.")]
    ...
    public static List<LuaExpr> ParseLuaSource(string sourceText, string sourceFile = "?.lua") {
        ...
        for (int i = 0; i < tokens.Count; i++) {
            expressions.Add(tokens[i].Type switch {
                ...
                _ => throw new Exception(tokens[i].Type.ToString()),
            });
